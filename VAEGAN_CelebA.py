...
from models import Discriminator, Generator, VariationalEncoder
from utils import get_dataset_celeba, reparameterize, loss_function_kld, get_model_and_optimizer, plot_real_vs_fake
...
dataloader = get_dataset_celeba(64)
